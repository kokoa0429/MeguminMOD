...
public class ItemWand extends ItemSword
{
	...
	/**コメント部分はとりあえず放置しておく*/
	@Override
	public boolean onItemUse(ItemStack stack,EntityPlayer entityplayer,World world, int x, int y, int z,int  par7 ,float par8,float par9, float par10){
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote){
			//world.spawnEntityInWorld(new Entitybakuretu(world, entityPlayer));

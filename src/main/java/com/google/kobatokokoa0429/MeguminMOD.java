...
public class MeguminMOD {
	...
	public void init(FMLInitializationEvent event){
		...
		//レシピ登録
		GameRegistry.addShapelessRecipe(new ItemStack(MeguminMOD.itemWand),
					MeguminMOD.itemWandStick,
					MeguminMOD.itemWandCore
				);
		GameRegistry.addRecipe(new ItemStack(MeguminMOD.itemWandStick),
				" XY",
				"XYX",
				"YX ",
				'Y',Items.stick,
        ...
        GameRegistry.addRecipe(new ItemStack(MeguminMOD.itemWandCore),
                "XXX",
                " ZY",
                "XXY",
                'X',Items.stick,
                'Y',Items.gold_ingot,
                'Z',MeguminMOD.itemManatite
        );

        ...
        else//埋まってない時。速度の更新。
        {
            		...
            		if (target instanceof EntityPlayer)
                    {
                        ...
                        else if (entityplayer == this.shootingEntity)
                        {
                        	...
                        	entityList.remove(n);
                                 ...
                                 target instanceof EntityHorse || target instanceof EntityAnimal)
                    {
            ...
            if (movingobjectposition != null)//blockのみ
            {
                if (!this.isPenetrateBlock())  //エンティティには当たってない。ブロックに当たった。
                {
                   ...
                   // worldObj.createExplosion(shootingEntity, posX, posY, posZ, 100F, true);

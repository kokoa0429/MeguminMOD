...
public class EntityBarretRender extends Render {
	...
	public void renderArrow(EntityBarret par1Entity, double par2, double par4, double par6, float par8, float par9) {
		// IModelCustom model = AdvancedModelLoader.loadModel(new
		// ResourceLocation(MeguminMOD.MOD_ID,"obj/hikati.obj"));
		// ResourceLocation texture = new
		// ResourceLocation(MeguminMOD.MOD_ID,"textures/blocks/skin.jpg");
		// bindTexture(texture);
		GL11.glPushMatrix();
		...
		GL11.glRotatef(par1Entity.prevRotationYaw + (par1Entity.rotationYaw - par1Entity.prevRotationYaw) * par9, 0.0F,
				1.0F, 0.0F);
		GL11.glRotatef(par1Entity.prevRotationPitch + (par1Entity.rotationPitch - par1Entity.prevRotationPitch) * par9,
				0.0F, 0.0F, 1.0F);
	...
	// protected ResourceLocation getArrowTextures(EntityVillagerHead
	// par1EntityArrow)
	// {

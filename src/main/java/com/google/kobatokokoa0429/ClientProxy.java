...
public class ClientProxy extends CommonProxy {
	...
	// public static void bindTileEntitySpecialRenderer(Class <? extends
	// TileEntity> tileEntityClass, TileEntitySpecialRenderer specialRenderer){
	...
	/*
	 * client側のTileEntity登録メソッド。 ここでは使用していませんが、TileEntityに独自レンダーを持たせたい場合、
	 * ClientRegistry.registerTileEntity(TileEntityのクラス名.class, "TileEntityの名前",
	 * new TileEntityのレンダ―クラス()); のように記述して、レンダークラスとTileEntityを登録します。
	 *
